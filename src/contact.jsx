        ...
        <div className="relative px-6 pb-20 pt-24 sm:pt-32 lg:static lg:px-8 lg:py-48">
          <div className="mx-auto max-w-xl lg:mx-0 lg:max-w-lg">
            ...
            <p className="mt-6 text-lg leading-8 text-gray-600">
              ...
              já se Vám ozvu co nejdříve. Setkání je možné v Praze, Jindřichově
              Hradci nebo blízkém okolí.
            </p>
              ...
              <div>
                ...
                <div className="mt-2.5">
                  <input
                    ...
                    className="transition-all block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-[#cf0029] sm:text-sm sm:leading-6"
                  />
                </div>
              </div>
              <div>
